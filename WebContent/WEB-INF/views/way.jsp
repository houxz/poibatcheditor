...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('[data-toggle="ways"]').bootstrapTable({
			locale : 'zh-CN',
			onPageChange : getWays
		});
	...
	function getWays() {
		...
		if (tabIndex == 0) {
			...
			$('[data-toggle="ways"]').bootstrapTable("showLoading");
			
			var params = {};
			params["columns"] = "";
			params["code"] = admincodes.join(",");
			params["number"] = $('[data-toggle="ways"]').bootstrapTable('getOptions').pageNumber;
			params["size"] = $('[data-toggle="ways"]').bootstrapTable('getOptions').pageSize;

			jQuery.post("./way.web", {
				"action" : "getWayByAdminCodes",
				"params" : JSON.stringify(params)
			}, function(json) {
				if (json.result && json.result > 0) {
					$('[data-toggle="ways"]').bootstrapTable("hideLoading");
					$('[data-toggle="ways"]').bootstrapTable("load", json);
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" onclick="getWays();">查询</button>
