...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('[data-toggle="direinfos"]').bootstrapTable({
			locale : 'zh-CN',
			onPageChange : getDireinfos
		});
	...
	function getDireinfos() {
		...
		if (tabIndex == 0) {
			...
			$('[data-toggle="direinfos"]').bootstrapTable("showLoading");
			
			var params = {};
			params["columns"] = "";
			params["code"] = admincodes.join(",");
			params["number"] = $('[data-toggle="direinfos"]').bootstrapTable('getOptions').pageNumber;
			params["size"] = $('[data-toggle="direinfos"]').bootstrapTable('getOptions').pageSize;

			jQuery.post("./direinfo.web", {
				"action" : "getDireinfoByAdminCodes",
				"params" : JSON.stringify(params)
			}, function(json) {
				if (json.result && json.result > 0) {
					$('[data-toggle="direinfos"]').bootstrapTable("hideLoading");
					$('[data-toggle="direinfos"]').bootstrapTable("load", json);
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" onclick="getDireinfos();">查询</button>
