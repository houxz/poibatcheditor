...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('[data-toggle="boundarys"]').bootstrapTable({
			locale : 'zh-CN',
			onPageChange : getBoundarys
		});
	...
	function getBoundarys() {
		...
		if (tabIndex == 0) {
			...
			$('[data-toggle="boundarys"]').bootstrapTable("showLoading");
			
			var params = {};
			params["columns"] = "";
			params["code"] = admincodes.join(",");
			params["number"] = $('[data-toggle="boundarys"]').bootstrapTable('getOptions').pageNumber;
			params["size"] = $('[data-toggle="boundarys"]').bootstrapTable('getOptions').pageSize;

			jQuery.post("./boundary.web", {
				"action" : "getBoundaryByAdminCodes",
				"params" : JSON.stringify(params)
			}, function(json) {
				if (json.result && json.result > 0) {
					$('[data-toggle="boundarys"]').bootstrapTable("hideLoading");
					$('[data-toggle="boundarys"]').bootstrapTable("load", json);
...
<body>
	<div class="container">
		...
		<div class="row" style="margin-top: 60px;">
			<table id="boundarylist"
				data-side-pagination="server"
				data-pagination="true" data-page-list="[10, 20, 50, 100]" data-page-size="10"
				data-toggle="boundarys"
				data-height="720"
				data-align='center'>
				<thead>
					<tr>
						<th data-field="boundary_id">区界ID
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" onclick="getBoundarys();">查询</button>
