...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('[data-toggle="lanes"]').bootstrapTable({
			locale : 'zh-CN',
			onPageChange : getLanes
		});
	...
	function getLanes() {
		...
		if (tabIndex == 0) {
			...
			$('[data-toggle="lanes"]').bootstrapTable("showLoading");
			
			var params = {};
			params["columns"] = "";
			params["code"] = admincodes.join(",");
			params["number"] = $('[data-toggle="lanes"]').bootstrapTable('getOptions').pageNumber;
			params["size"] = $('[data-toggle="lanes"]').bootstrapTable('getOptions').pageSize;

			jQuery.post("./lane.web", {
				"action" : "getLaneByAdminCodes",
				"params" : JSON.stringify(params)
			}, function(json) {
				if (json.result && json.result > 0) {
					$('[data-toggle="lanes"]').bootstrapTable("hideLoading");
					$('[data-toggle="lanes"]').bootstrapTable("load", json);
