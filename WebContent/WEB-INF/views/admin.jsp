...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('[data-toggle="admins"]').bootstrapTable({
			locale : 'zh-CN',
			onPageChange : getAdmins
		});
	...
	function getAdmins() {
		...
		if (tabIndex == 0) {
			...
			$('[data-toggle="admins"]').bootstrapTable("showLoading");
			
			var params = {};
			params["columns"] = "";
			params["code"] = admincodes.join(",");
			params["number"] = $('[data-toggle="admins"]').bootstrapTable('getOptions').pageNumber;
			params["size"] = $('[data-toggle="admins"]').bootstrapTable('getOptions').pageSize;

			jQuery.post("./admin.web", {
				"action" : "getAdminByAdminCodes",
				"params" : JSON.stringify(params)
			}, function(json) {
				if (json.result && json.result > 0) {
					$('[data-toggle="admins"]').bootstrapTable("hideLoading");
					$('[data-toggle="admins"]').bootstrapTable("load", json);
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" onclick="getAdmins();">查询</button>
