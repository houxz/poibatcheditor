...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('[data-toggle="builtupareas"]').bootstrapTable({
			locale : 'zh-CN',
			onPageChange : getBuiltupareas
		});
	...
	function getBuiltupareas() {
		...
		if (tabIndex == 0) {
			...
			$('[data-toggle="builtupareas"]').bootstrapTable("showLoading");
			
			var params = {};
			params["columns"] = "";
			params["code"] = admincodes.join(",");
			params["number"] = $('[data-toggle="builtupareas"]').bootstrapTable('getOptions').pageNumber;
			params["size"] = $('[data-toggle="builtupareas"]').bootstrapTable('getOptions').pageSize;

			jQuery.post("./builtuparea.web", {
				"action" : "getBuiltupareaByAdminCodes",
				"params" : JSON.stringify(params)
			}, function(json) {
				if (json.result && json.result > 0) {
					$('[data-toggle="builtupareas"]').bootstrapTable("hideLoading");
					$('[data-toggle="builtupareas"]').bootstrapTable("load", json);
...
<body>
	<div class="container">
		...
		<div class="row" style="margin-top: 60px;">
			<table id="builtuparealist"
				data-side-pagination="server"
				data-pagination="true" data-page-list="[10, 20, 50, 100]" data-page-size="10"
				data-toggle="builtupareas"
				data-height="720"
				data-align='center'>
				<thead>
					<tr>
						<th data-field="builtuparea_id">建成区ID
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" onclick="getBuiltupareas();">查询</button>
